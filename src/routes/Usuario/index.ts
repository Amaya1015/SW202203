...
router.get('/byindexusuario/:index', async (req, res) => {
  try {
...
router.post('/testvalidatorusuario', async (req, res)=>{
...
router.put('/updateusuario/:index', async (req, res)=>{
  try {
    const { index } = req.params;
...
router.delete('/deleteusuario/:index', (req, res)=>{
  try {
    const { index } = req.params;
